...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-slate-50 dark:bg-transparent transition-colors">
      
      {/* Background Glow Decorations (Glassmorphic) */}
      <div className="absolute top-1/4 left-1/10 w-72 h-72 bg-indigo-400/15 rounded-full blur-3xl dark:bg-indigo-600/5"></div>
      <div className="absolute bottom-1/4 right-1/10 w-96 h-96 bg-teal-400/15 rounded-full blur-3xl dark:bg-teal-600/5"></div>
